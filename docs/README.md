...
| [**Controller notes**](controller-notes.md) | Measured behaviour of the controller this driver was developed against: static facts, exact alarm texts, recovery procedures, and what is still unsettled. |
