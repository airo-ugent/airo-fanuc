...
_OPERATOR_HINT: dict[FaultReason, str] = {
    ...
    FaultReason.RX_SILENT: "Stream Motion is silent — check the eno2 link / power-cycle the controller.",
    FaultReason.RX_DEGRADED: "Intermittent Stream Motion RX — check the network / IRQ placement.",
    FaultReason.FORCE_GUARD: "Force-guard tripped — clear the contact and replan.",
    FaultReason.DRIFT: "Command/measured drift exceeded the guard — replan from the measured pose.",
